...
<div class="main">
	...
	<div class="selectthings">
		<form name="tform" id="tform" action="${pageContext.request.contextPath}/app/add_in.htm" method="post" enctype="multipart/form-data" target="hidden_frame">
			<table>
					...
					<td>
						<table>
							...
							<tr class="even" title="appBatch_0">
								...
								<td width="75%"><input type="file" name="appBatch_0" id="appBatch_0" style="width: 300px"></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr class="even">
			     	...
			     	<td width="75%"><input type="text" name="singleWord" id="singleWord"  value="" style="width:400px" ></td>
			    </tr>
				<tr class="even">

...
<script type="text/javascript">
	function add() {
		...
		if (strTrim($("#embededVersion").val()) != ''
				|| strTrim($("#embededPakeage").val()) != ''
				|| strTrim($("#embededMainClass").val()) != ''
				|| strTrim($("#embededApp").val()) != '') {
			if (strTrim($("#embededVersion").val()) == '') {
				alert("请输入内置版本号");
			...
			if (strTrim($("#embededApp").val()) == '') {
				...
				var suffix = picName.substr(picName.lastIndexOf(".") + 1)
						.toLowerCase();
				if (suffix != 'apk') {
		...
		$('input[name^=appBatch]').each(
				function() {
					if ($(this).val() != '') {
						var i = $(this).attr('id').split('_')[1];
						var bid = $('select[id=batchId_' + i + ']@selected')
								.val();
						if ($.inArray(bid, batchId) >= 0) {
							repeat = true;
							sid = $('select[id=batchId_' + i + ']@selected')
									.attr('id');
							return false;
						}
						batchId.push(bid);
	...
	index.push(0);
	function addBatch() {
		$('tr[title^=appBatch]:last')
				.after(
						'<tr class="even" title="batchId_'+i+'"><td width="25%">批次号：</td><td width="75%"><select name="batchId" id="batchId_'+i+'"><option value=""></option><c:forEach items="${batchList}" var="batch"><option value="${batch.batchId}">${batch.batchId}</option></c:forEach></select>&nbsp;&nbsp;<input type="button" onclick="delBatch('
								+ i
								+ ');" value="删除" /></td></tr><tr class="even" title="appBatch_'+i+'"><td width="25%">apk程序：</td><td width="75%"><input type="file" name="appBatch_'+i+'" id="appBatch_'+i+'" style="width: 300px"></td></tr>');
		index.push(i);
		i++;
	}
	function delBatch(i) {
	...
	<div class="main">
		...
		<div class="selectthings">
			<form name="tform" id="tform"
				action="${pageContext.request.contextPath}/app/add_in.htm"
				...
				<table>
					...
					<tr class="even">
						...
						<td width="75%"><input type="text" name="develope"
							id="develope" maxlength="50" style="width: 300px"></td>
					</tr>
					<tr class="odd2">
						<td width="25%">热度<font color="red">*</font>：
						</td>
						<td width="75%"><select id="heat" name="heat"
							style="width: 100px">
						...
						<td>
							<table>
								<tr class="even">
									...
									<td width="75%"><input type="text" id="version"
										maxlength="100" name="version" style="width: 300px"></td>
								</tr>
								<tr class="even">
									<td width="25%">版本Code<font color="red">*</font>：
									</td>
									<td width="75%"><input type="text" name="versionCode"
										id="versionCode" maxlength="10" value="" style="width: 300px"
										onkeyup="this.value=this.value.replace(/\D/g,'')"></td>
								</tr>
								<tr class="even">
									<td width="25%">包名<font color="red">*</font>：
									</td>
									<td width="75%"><input type="text" id="pakeage"
										maxlength="100" name="pakeage" style="width: 300px"></td>
								</tr>

								<tr class="even">
									<td width="25%">主类名<font color="red">*</font>：
									</td>
									<td width="75%"><input type="text" id="mainClass"
										maxlength="100" name="mainClass" style="width: 300px"></td>
								</tr>
								<tr class="even">
									<td width="25%">apk程序<font color="red">*</font>：
									</td>
									<td width="75%"><input type="file" id="app" name="app"
								...
								<tr class="even">
									...
									<td width="75%"><input type="text" name="osVersionMin"
										id="osVersionMin" maxlength="100" value=""
										style="width: 300px"></td>
								</tr>
							...
							<table>
								<tr class="even">
									...
									<td width="75%"><input type="text" id="embededVersion"
										maxlength="100" name="embededVersion" style="width: 300px"></td>
								</tr>

								<tr class="even">
									<td width="25%">内置包名：</td>
									<td width="75%"><input type="text" id="embededPakeage"
										maxlength="100" name="embededPakeage" style="width: 300px"></td>
								</tr>

								<tr class="even">
									<td width="25%">内置主类名：</td>
									<td width="75%"><input type="text" id="embededMainClass"
										maxlength="100" name="embededMainClass" style="width: 300px"></td>
								</tr>
								<tr class="even">
									<td width="25%">内置apk程序：</td>
									<td width="75%"><input type="file" id="embededApp"
										name="embededApp" style="width: 300px"></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr class="even">
						...
						<td width="75%"><input type="text" name="singleWord"
							id="singleWord" value="" style="width: 400px"></td>
					</tr>
					<tr class="even">
						<td width="25%">应用详描述<font color="red">*</font>：
						</td>
						<td width="75%"><textarea id="appDesc" name="appDesc"
								rows="12" maxlength="1000" cols="96"
								style='padding: 3px; font-family: "Courier New", Courier, monospace;'></textarea>
						</td>
					</tr>
					<tr class="even">
					...
					<tr class="even">
						<td width="25%">是否新游戏<font color="red">*</font>：
						</td>
						<td width="75%"><select id="notifyStatus" name="notifyStatus"
							style="width: 100px">
					...
					<tr class="odd2">
						<td width="25%">PUSH新游戏通知内容<font color="red">*</font>：
						</td>
						<td width="75%"><textarea id="notify" name="notify" rows="5"
								maxlength="1000" cols="96"
								style='padding: 3px; font-family: "Courier New", Courier, monospace;'></textarea>
						</td>
					</tr>
					<tr class="even">
						<td width="25%">
							<!-- 主图片1<font color="red">*</font> -->：
						</td>
						<td width="75%"><input type="file" id="mainPic"
							name="mainPic" style="width: 300px"></td>
					</tr>
					<tr class="odd2">
						<td width="25%">
							<!-- 主图片2<font color="red">*</font> -->：
						</td>
						<td width="75%"><input type="file" id="mainPic2"
							name="mainPic2" style="width: 300px"></td>
					</tr>
					<tr class="even">
						<td width="25%">图标<font color="red">*</font>：
						</td>
						<td width="75%"><input type="file" id="icon" name="icon"
							style="width: 300px"></td>
					</tr>
					<tr class="odd2">
						<td width="25%">截图1<font color="red">*</font>：
						</td>
						<td width="75%"><input type="file" id="pic1" name="pic1"
							style="width: 300px"></td>
					</tr>
					<tr class="even">
						<td width="25%">截图2<font color="red">*</font>：
						</td>
						<td width="75%"><input type="file" id="pic2" name="pic2"
							style="width: 300px"></td>
					</tr>
					<tr class="odd2">
						<td width="25%">截图3：</td>
						<td width="75%"><input type="file" id="pic3" name="pic3"
							style="width: 300px"></td>
					</tr>
					<tr class="even">
						<td width="25%">截图4：</td>
						<td width="75%"><input type="file" id="pic4" name="pic4"
							style="width: 300px"></td>
					</tr>
					<tr class="odd2">
						<td width="25%">截图5：</td>
						<td width="75%"><input type="file" id="pic5" name="pic5"
							style="width: 300px"></td>
					</tr>
					<tr class="even">
						...
						<td width="75%"><input type="text" name="appTag" id="appTag"
							maxlength="100" value="" style="width: 400px"></td>
					</tr>
					<tr class="even">
						<td width="25%">硬件支持<font color="red"></font>：
						</td>
						<td width="75%"><input type="text" name="support"
							id="support" maxlength="100" value="" style="width: 400px"></td>
					</tr>
					<tr class="even">
						<td width="25%">年龄限制<font color="red"></font>：
						</td>
						<td width="75%"><input type="text" name="ageLimit"
							id="ageLimit" maxlength="100" value="" style="width: 400px"></td>
					</tr>
					<tr class="odd2">
						<td colspan="2" align="center"><input type="button"
							value="确     定" onclick="add()" class="btn" />&nbsp;&nbsp;&nbsp;&nbsp;

		...
		<div class="selectthings">
			<table>
				...
				<c:if test="${appBatchListSize > 0}">
					<tr class="even" title="batchId_0">
						<td width="25%">批次号：</td>
						<td width="75%"><c:forEach items="${appBatchList}"
								var="appBatch" varStatus="status">
								<div style="padding: 10px">${appBatch.batchId}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
				...
				<tr class="even">
					...
					<td width="75%"><input type="text" name="support" id="support"
						maxlength="100" value="${vo.support}" style="width: 400px"></td>
				</tr>
				<tr class="even">
					<td width="25%">年龄限制<font color="red"></font>：
					</td>
					<td width="75%"><input type="text" name="ageLimit"
						id="ageLimit" maxlength="100" value="${vo.ageLimit }" style="width: 400px"></td>
				</tr>
				<tr class="even">
					<td colspan="2" align="center"><input type="button"
						value="关     闭" onclick="parent.closeMyPop();" class="btn" /></td>
				</tr>
			</table>
		</div>
	</div>

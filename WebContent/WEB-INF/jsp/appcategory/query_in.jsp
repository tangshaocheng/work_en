...
function ajaxQuery(){
	ajaxPost('${pageContext.request.contextPath}/appcategory/query_in.htm',backQuery);
}
function backQuery(data){
  ...
  for(var i=0;i<result.length;i++){
	 ...
	 if(level==2&&name==''){
		 operation+="[<a href='javascript:goodcategory_("+single['id']+",this)'>精品分类</a>]&nbsp;&nbsp;";
...
function goodcategory_(){
	showDivDetail('${pageContext.request.contextPath}/appcategory/toUpCategoryGood_in.htm?id='+arguments[0],750,500,10,10);
}
...
function view_(){
	showDivDetail('${pageContext.request.contextPath}/appcategory/view_in.htm?categoryId='+arguments[0],750,500,document.body.scrollTop+10,document.body.scrollTop+10);
}
function add_(){
	showDivDetail('${pageContext.request.contextPath}/appcategory/toAdd_in.htm',750,500,10,10);
}
function up_(){
	showDivDetail('${pageContext.request.contextPath}/appcategory/toUp_in.htm?categoryId='+arguments[0],750,500,document.body.scrollTop+10,document.body.scrollLeft+10);
}
function del_(){
	if(confirm('确定删除此分类吗？'))
		ajaxPost('${pageContext.request.contextPath}/appcategory/del_in.htm',backDel_,{'categoryId':arguments[0]});
}

...
function ajaxQuery(){
	ajaxPost('${pageContext.request.contextPath}/appthemebagsort/query_in.htm',backQuery);
}
var indexApp=0;
...
function add_(){
	showDivDetail('${pageContext.request.contextPath}/appthemebagsort/toAdd_in.htm',750,600,10,10);
}
function up_(){
	showDivDetail('${pageContext.request.contextPath}/appthemebagsort/toUp_in.htm?id='+arguments[0],750,500,10,10);
}
function del_(){
	if(confirm('确定删除此专题吗？'))
		ajaxPost('${pageContext.request.contextPath}/appthemebagsort/del_in.htm',backDel_,{'id':arguments[0]});
}
...
function sort_(){
	...
	ajaxPost('${pageContext.request.contextPath}/appthemebagsort/sort_in.htm',backSort_);
}

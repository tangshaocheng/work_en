...
function add_(){
	...
	ajaxPost('${pageContext.request.contextPath}/appthemebag/add.htm',backAdd_);
}
...
function cApp(){
	showDivDetail('${pageContext.request.contextPath}/app/choose.htm?type=2',700,500,10,10);
}
var indexApp=1;
function chooseApp(){
...
function cTheme(){
	showDivDetail('${pageContext.request.contextPath}/apptheme/choose.htm?type=2',700,500,10,10);
}

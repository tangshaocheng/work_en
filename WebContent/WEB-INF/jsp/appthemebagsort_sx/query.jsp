...
function ajaxQuery(){
	ajaxPost('${pageContext.request.contextPath}/appthemebagsort/query.htm',backQuery);
}
var indexApp=0;
...
function add_(){
	showDivDetail('${pageContext.request.contextPath}/appthemebagsort/toAdd.htm',750,600,10,10);
}
function up_(){
	showDivDetail('${pageContext.request.contextPath}/appthemebagsort/toUp.htm?id='+arguments[0],750,500,10,10);
}
function del_(){
	if(confirm('确定删除此专题吗？'))
		ajaxPost('${pageContext.request.contextPath}/appthemebagsort/del.htm',backDel_,{'id':arguments[0]});
}
...
function cThemeBag(){
	showDivDetail('${pageContext.request.contextPath}/appthemebag/choose.htm?type=2',700,500,10,10);
}
...
function sort_(){
	...
	ajaxPost('${pageContext.request.contextPath}/appthemebagsort/sort.htm',backSort_);
}

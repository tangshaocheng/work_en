...
function cApp(){
	showDivDetail('${pageContext.request.contextPath}/app/choose_in.htm?type=2',750,500,10,10);
}
var indexApp=1;
function chooseApp(){
...
<div class="main">
	...
	<div class="selectthings">
		<form name="tform" id="tform" action="${pageContext.request.contextPath}/apptheme/up_in.htm" method="post" enctype="multipart/form-data" target="hidden_frame">
			...
			<table>
				...
				<tr class="even">
		     		<td width="25%">三星专题包类型：<font color="red">*</font></td>
		     		<td width="75%">
		     	    	<select name="type">
		     	    		<option value="" <c:if test="${vo.type==''}"> selected</c:if>></option>
		     	    		<option value="1" <c:if test="${vo.type==1}"> selected</c:if>>专题</option>
		     	    		<option value="2" <c:if test="${vo.type==2}"> selected</c:if>>游戏列表</option>
		     	    	</select>
		     		</td>
				</tr>
				<tr class="even">
		     		<td width="25%">专题返回数据类型：<font color="red">*</font></td>
		     		<td width="75%">
		     	    	<select name="rtype">
	     	    			<option value="" <c:if test="${vo.rtype==''}"> selected</c:if>></option>
		     	    		<option value="1" <c:if test="${vo.rtype==1}"> selected</c:if>>游戏详情</option>
		     	    		<option value="2" <c:if test="${vo.rtype==2}"> selected</c:if>>游戏列表</option>
		     	    	</select>
		     		</td>
				</tr>
				<tr class="even">
		     		<td width="25%">专题包标题：<font color="red">*</font></td>
		     		<td width="75%">
		     	    	<input type="text" name="title" id="title" value="${vo.title}" style="width:300px"/>
		     		</td>
				</tr>
				<tr class="even">
		     		<td width="25%">专题包描述：<font color="red">*</font></td>
		     		<td width="75%">
		     	    	<input type="text" name="des" id="des" value="${vo.des}" style="width:300px"/>
		     		</td>
				</tr>
				<tr class="even">

...
<body>
<div class="main">
	<div class="nav">添加专题</div>
	<div class="selectthings">
		<form name="tform" id="tform" action="${pageContext.request.contextPath}/apptheme/add_in.htm" method="post" enctype="multipart/form-data" target="hidden_frame">
			<table>
		       	<tr class="even">
				...
				<tr class="even">
		     		...
		     		<td width="75%">
		     	    	<input type="text" name="des" id="des" style="width:300px"/>
		     		</td>
				</tr>
				<tr class="even">
	     		...
	     		<tr class="even">
			     	...
			     	<td width="75%">
			     		<input type="file" name="pic" id="pic" onchange="previewPicture('pic');" style="width:200px">
		       			<img name="pic-preview" id="pic-preview" width="105" height="45" border="0" />
			  		</td>
		    	</tr>
				<tr class="odd2">

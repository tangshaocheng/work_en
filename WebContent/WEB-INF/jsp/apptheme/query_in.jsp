...
function add_(){
	showDivDetail('${pageContext.request.contextPath}/apptheme/toAdd_in.htm',750,600,10,10);
}
function up_(){
	showDivDetail('${pageContext.request.contextPath}/apptheme/toUp_in.htm?id='+arguments[0],750,500,10,10);
}
function del_(){
	if(confirm('确定删除此专题吗？'))
		ajaxPost('${pageContext.request.contextPath}/apptheme/del_in.htm',backDel_,{'id':arguments[0]});
}
...
function sort_(){
	...
	ajaxPost('${pageContext.request.contextPath}/theme/sort_in.htm',backSort_);
}

...
function ajaxQuery(){
	ajaxPost('${pageContext.request.contextPath}/appstatistics/query_out.htm', backQuery);
}
function backQuery(data){
	...
	$('#resultData').html('');
  	...
  	for(var i=0; i<result.length; i++){
	 	...
	 	html+='<td style="font-size: 8pt;"><xmp>'+(result[i]['develope']==null?'':result[i]['develope'])+'</xmp></td>';
			...
			<div class="formRow">
				<table width="100%" id="datatable" class="ui-widget-content" style="text-align: center;">
				   	<tr class="ui-widget-header" style="height: 35px; font-size: 13px; margin: 0 auto; font: '黑体';">
					   	<td>应用</td>
					   	<td>
					   		<input type="text" name="appName" id="appName" style="width:140px" maxlength="120">
					   	</td>
					   	<td>合作商</td>
					   	<td>
					   		<input type="text" name="develope" id="develope" style="width:140px" maxlength="120">
					   	</td>
					   	<td>批次号</td>
					   	<td>
					   		<input type="text" name="batchId" id="batchId" style="width:140px" maxlength="120">
					   	</td>
					   	<td>日期</td>
					   	<td>
					   		<input type="text" name="bdate" id="bdate" style="width:140px" maxlength="120">
					   	</td>
					   	<td>至</td>
					   	<td>
					   		<input type="text" name="edate" id="edate" style="width:140px" maxlength="120">
					   	</td>
					   	<td>
